...
const UserProfile = () => {
  ...
  return (
    ...
    <div className='profile max-w-4xl lg:mx-auto bg-[#3d6aa6] mt-10 rounded-2xl shadow-shd mx-4 relative h-[500px] dark:bg-gray-800'>
       ...
       <div className="dtls max-w-2xl mx-auto py-4 px-3">
        <div className="first flex flex-col md:flex-row md:items-center justify-between border-b-2 border-blue-400 bg-[#6495ed] dark:bg-[#121314] dark:text-white px-3 py-4 mb-4 hover:bg-blue-800 hover:text-white rounded-xl relative transition-all duration-300">
